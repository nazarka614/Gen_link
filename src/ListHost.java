public class ListHost {
    ...
    public String[] getHostCharterSMB() {
        return new String[]{
...
//    }
    ...
    public String[] getHostsFRONTIER() {
        return new String[]{
    ...
    public String[] getHostsVERSATEL() {
        return new String[]{
